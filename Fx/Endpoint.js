class Endpoint {
    static FX_GET_CURRENCY_RATE = "https://flexie.io/currency";

    static FX_NEW_INVOICE = {
    ...
    static FX_PARAMETER_VALIDATION = {
